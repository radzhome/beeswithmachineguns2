...
A utility for arming (creating) many bees (micro EC2 instances) to attack (load test) targets (web applications) using tools like ab (primarily) and hurl.
...
h2. TODO
# TODO: wrk2
# TODO: Create own sg by default, with port 22 open
...
<pre>
pip install https://github.com/radzhome/beeswithmachineguns2/archive/master.zip
</pre>

h2. Installation for developers (w/ virtualenv + virtualenvwrapper)

<pre>
git clone git://github.com/radzhome/beeswithmachineguns2.git
cd beeswithmachineguns2
...
Create a security group that has public access on port 22 and use this when you run bees i.e. public or bees-test-sg
...
Another example
<pre>
./bees up -s 1 -k mykey -z ca-central-1a -l ec2-user -i ami-0f552e0a86f08b660 -g group-22-open --subnet my-subnet
</code>
...
For more information about *hurl* please visit https://github.com/VerizonDigital/hlx
  ...
  Multi regional testing was added so user can call up multiple bees from different regions simultaneously. Users have the ability to “up”, “attack”, and  “down” instances from single command.
...
Please log your bugs on the "Github issues tracker":http://github.com/radzhome/beeswithmachineguns2/issues.
